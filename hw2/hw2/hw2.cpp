...
namespace
{
    ...
    constexpr UINT kTriangleIndexCount = 3;
    ...
    {
        { { -0.5f, -0.5f, 0.0f }, PackColor(255, 0, 0) },
        { {  0.5f, -0.5f, 0.0f }, PackColor(0, 255, 0) },
        { {  0.0f,  0.5f, 0.0f }, PackColor(0, 0, 255) },
    };

    constexpr std::uint16_t kTriangleIndices[] = { 0, 1, 2 };
    ...
    bool CreateTriangleGeometry()
    {
        ...
        vertexBufferDesc.ByteWidth = static_cast<UINT>(sizeof(kTriangleVertices));
        vertexBufferDesc.Usage = D3D11_USAGE_IMMUTABLE;
        vertexBufferDesc.BindFlags = D3D11_BIND_VERTEX_BUFFER;

        D3D11_SUBRESOURCE_DATA vertexData = {};
        vertexData.pSysMem = kTriangleVertices;
        ...
        indexBufferDesc.ByteWidth = static_cast<UINT>(sizeof(kTriangleIndices));
        indexBufferDesc.Usage = D3D11_USAGE_IMMUTABLE;
        indexBufferDesc.BindFlags = D3D11_BIND_INDEX_BUFFER;

        D3D11_SUBRESOURCE_DATA indexData = {};
        indexData.pSysMem = kTriangleIndices;
    ...
    void RenderFrame()
    {
        ...
        g_deviceContext->DrawIndexed(kTriangleIndexCount, 0, 0);
